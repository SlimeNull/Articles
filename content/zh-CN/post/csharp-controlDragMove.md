...
对鼠标拖动实现控件移动的原理详解, 以及使用类将功能封装, 实现一个类管理多个控件的拖动.
...
![添加按钮控件](https://img-blog.csdnimg.cn/20200706052109567.png)
3. 添加相关事件(MouseDown, MouseMove, MouseUp):
![添加相关事件](https://img-blog.csdnimg.cn/20200706052323882.png)
4. 转到代码, 添加相关变量.
![添加相关变量](https://img-blog.csdnimg.cn/20200706052556910.png)
5. 添加关键代码:
![代码图片](https://img-blog.csdnimg.cn/20200706054641301.png)
