---
title: "[Linux] Kali Linux 记录 - 死锁, 依赖 'Unable to install new version of ...libpng12.so.0 no such file or directory'"
...
既然无法通过 apt 来移除软件包, 那就用 dpkg 移除吧!
...
5. 查资料, 查资料, 查资料, 经过一段时间的周旋, 我顿悟了, 既然不能用 apt, 就用 dkpg 啊, 很快啊， 我打开终端， 用 dpkg 把 sunloginclient 给移除了， 然后顺理成章的把libwebkitgtk， libpng12.so.0给移除了
