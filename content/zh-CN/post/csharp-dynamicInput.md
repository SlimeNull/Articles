...
(旧的) 在使用 Console.ReadLine 的时候, 用户不按回车确认, 你就无法获取用户输入了什么内容, 于是我封装了一个类实现获取用户输入内容

<!--more-->

> 注意，这里是在我刚学C#时写的，但我不想删除任何我的足迹. 
> ==这个类库不是完善的，如果需要完整功能(真的很好用)，请去我的新文章==: [[C#] 控制台动态输入 - 增强版ReadLine()](https://blog.csdn.net/m0_46555380/article/details/111998667)
