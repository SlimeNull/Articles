---
title: "[踩坑记录] Image.Save 遇到 A generic error occurred in GDI+ 异常"
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020082621482447.png)

> 最后, 这个程序是用于根据atlas图像索引表分解图像的, 如果你觉得有参考价值, 可以私信我
> ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200826215228152.png)