...
WinForm, 借助 Graphics 绘制函数图像, 可拖动, 可缩放, 可调整精度, 可自定义表达式

<!--more-->

![xPIFuHhf59](/assets/202102192200/xPIFuHhf59.gif)
...
![](/assets/202102192200/1.png)
然后, 标尺, 也是一个个线呗, 那个数字的话, 就是这个:
![](/assets/202102192200/2.png)
填充小三角的话, 就是这个:
![](/assets/202102192200/3.png)
...
```
#### 注意事项:
Graphics 在绘制某些超级远的东西时, 例如这个坐标时 (2147483647,2147483647), 总之就是非常大, 那可能会不能绘制, 报 Overflow 异常
#### 还有一些要用的内容:
CSDN 文章: [C# 中的 Range 函数](https://blog.csdn.net/m0_46555380/article/details/113856477)
CSDN 文章: [C# IEnumerable 连接, 将迭代器串起来](https://blog.csdn.net/m0_46555380/article/details/113858389)
#### 更新记录:
最新版本已经支持自定义函数表达式
